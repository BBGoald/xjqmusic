	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = LayoutInflater.from(context).inflate(
					R.layout.item_local_songs_list, null);
			holder.layoutPLay = (LinearLayout) convertView
					.findViewById(R.id.lay_play);
			holder.moreImageButton = (ImageButton) convertView
			...
			holder.btnAddToPlayOrDeleteList = (ImageButton) convertView
					.findViewById(R.id.btn_add_to_list);
			holder.linearLayout = (LinearLayout) convertView
					.findViewById(R.id.expandable);
			holder.myFavoriteLayout = (LinearLayout) convertView
					.findViewById(R.id.layout_play_fav);
			holder.downLoadLayout = (LinearLayout) convertView
		...
		if (isEditor) {
			...
			holder.btnAddToPlayOrDeleteList
					.setImageResource(R.drawable.list_btn_add);
		}
